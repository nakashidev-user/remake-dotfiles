return {
	...
	-- 		codewindow.setup({
	-- 			auto_enable = false, -- バッファ入室で自動表示
	-- 			minimap_width = 10, -- VSCode っぽい幅
	-- 			width_multiplier = 4, -- 1ドットあたりの文字数（横の圧縮率）
	-- 			max_minimap_height = nil, -- 高さ制限なし＝画面高いっぱい使う
	-- 			use_lsp = true, -- 診断を表示
	-- 			use_treesitter = true, -- ハイライトを反映
	-- 			use_git = true, -- Git差分の点を表示
	-- 			show_cursor = true, -- カーソル点は非表示（好み）
	-- 			screen_bounds = "background", -- 画面内を背景で示す（VSCode風）
	-- 			window_border = "single", -- 枠線
	-- 			relative = "editor", -- 画面全体に相対配置＝常に右端固定感
	-- 			z_index = 1, -- 必要なら上げる
	-- 			exclude_filetypes = { "help", "neo-tree", "lazy", "TelescopePrompt" },
	-- 			events = { "TextChanged", "InsertLeave", "DiagnosticChanged", "FileWritePost" },
	-- 		})
	-- 		codewindow.apply_default_keybinds()
	-- 		-- 追加の手動トグル
	-- 		vim.keymap.set("n", "<leader>mm", codewindow.toggle_minimap, { desc = "Minimap Toggle" })
	-- 	end,
	-- },
	-- {
